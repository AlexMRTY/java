package asif.shirvan.demo.shapes; // TODO: Change to your package name
...
public class World {
    ...
    public World(double width, double height) {
        ...
        shapes = new Shape[3];
        shapes[0] = new Rectangle(20, 30, Color.GREEN, 100, 100);
        shapes[1] = new Circle(50, 60, Color.ORANGE, 100);
        shapes[2] = new Line(0, 0, Color.BLACK, 50, 50);
        for (Shape s : shapes) {
            s.setVelocity(500, 500);
